...
typedef struct product{
	char Num[10];         //产品编号 10位 
	char Location[15];    //出行地点 15位 
	char Date[10];        //出行日期 10位 
	char Information[80]; //产品信息 80位 
	char Amount[10];      //销售数量 10位 
	char Price[10];       //产品价格 10位 
